"""
This champion will move, but stop after a certain number of frames have elapsed.
It is meant to provide a very crude solution to Training Movement 02 where
...
class Champion:
    ...
    def battle_plan(self, battle: BattleAPI):
        # The game runs at 30 frames per second, so move for only 6 seconds
        if self.frames < 30 * 6:
